...
export const nominees: Record<number, YearNominees> = {
  ...
  2016: {
    openings: [
      ...
      { id: '7',  animeName: 'Assassination Classroom',                 openingTitle: 'Bye Bye Yesterday',              artist: '3-nen E-gumi Utatan',       op: 4,  image: '/2016/OPENING/Cover/ASSASSINATION.png',  audio: ''                                        },
  ...
  2015: {
    openings: [
      ...
      { id: '12', animeName: 'Fairy Tail',                                openingTitle: 'BREAK OUT',                                artist: 'V6',                                        op: 18, image: '/2015/OPENING/Cover/FT.jpg',          audio: ''                                    },
